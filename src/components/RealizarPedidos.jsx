...
function PizzaCard({ img, name, description, aosDelays, onSelect }) {
    return (
        <div className='max-w-xs rounded overflow-hidden shadow-lg p-4' data-aos='fade-up' data-aos-delay={aosDelays}>
    ...
    return (
      <div className="bg-gradient-to-r from-red-500 to-yellow-500 min-h-screen flex flex-col items-center justify-center py-8">
          <div className="container mx-auto">
              <h2 className="text-2xl font-bold my-4 text-center text-white">Realizar Pedido</h2>
